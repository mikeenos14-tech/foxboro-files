...
export const teamStats: TeamStatSnapshot = {
  ...
  discipline: {
    penaltiesCommitted: { value: 5, leagueRank: 10, leaguePercentile: 71 },
    penaltyYardsCommitted: { value: 38, leagueRank: 12, leaguePercentile: 65 },
    mostPenalized: { playerName: "M. Wallace", count: 2 },
  },
};

export const positionGroupReportCards: PositionGroupReportCard[] = [
  { group: "QB", grade: 78, trend: "up", soWhat: "Efficient, protecting the ball — top-10 turnover-worthy play rate.", windows: [], statLine: "", sampleSize: 0, confidence: "low" },
  { group: "RB", grade: 71, trend: "flat", soWhat: "Solid between the tackles, not yet a explosive-play threat.", windows: [], statLine: "", sampleSize: 0, confidence: "low" },
  { group: "WR", grade: 62, trend: "down", soWhat: "Separation has been inconsistent — below-average target depth.", windows: [], statLine: "", sampleSize: 0, confidence: "low" },
  { group: "TE", grade: 69, trend: "up", soWhat: "Emerging as a reliable third-down safety valve.", windows: [], statLine: "", sampleSize: 0, confidence: "low" },
  { group: "Pass Protection", grade: 74, trend: "up", soWhat: "Best unit on the team right now — top-10 pressure rate allowed.", windows: [], statLine: "", sampleSize: 0, confidence: "low" },
  { group: "Pass Rush", grade: 66, trend: "flat", soWhat: "Generating pressure without finishing — sacks lag win rate.", windows: [], statLine: "", sampleSize: 0, confidence: "low" },
  { group: "Run Defense", grade: 70, trend: "up", soWhat: "Run defense has been stout early — top-10 stuff rate.", windows: [], statLine: "", sampleSize: 0, confidence: "low" },
  { group: "Pass Defense", grade: 73, trend: "up", soWhat: "Ball-hawking early — leads league in turnover-worthy pass breakups.", windows: [], statLine: "", sampleSize: 0, confidence: "low" },
];
...
export const positionGroupLeagueTable: PositionGroupLeagueTeamEntry[] = [
  {
    ...
    groups: [
      ...
      { group: "Pass Protection", grade: 74, rawValue: 0.04, rawLabel: "Sack rate allowed (excl. QB fault)" },
      { group: "Pass Rush", grade: 66, rawValue: 0.07, rawLabel: "Sack rate generated" },
      { group: "Run Defense", grade: 70, rawValue: -0.09, rawLabel: "Rush EPA allowed" },
      { group: "Pass Defense", grade: 73, rawValue: -0.12, rawLabel: "Pass EPA allowed" },
    ],
  },
  {
    team: "PIT",
    groups: [
      ...
      { group: "Pass Protection", grade: 40, rawValue: 0.09, rawLabel: "Sack rate allowed (excl. QB fault)" },
      { group: "Pass Rush", grade: 82, rawValue: 0.12, rawLabel: "Sack rate generated" },
      { group: "Run Defense", grade: 58, rawValue: -0.03, rawLabel: "Rush EPA allowed" },
      { group: "Pass Defense", grade: 61, rawValue: -0.06, rawLabel: "Pass EPA allowed" },
    ],
  },
  {
    team: "JAX",
    groups: [
      ...
      { group: "Pass Protection", grade: 63, rawValue: 0.05, rawLabel: "Sack rate allowed (excl. QB fault)" },
      { group: "Pass Rush", grade: 57, rawValue: 0.06, rawLabel: "Sack rate generated" },
      { group: "Run Defense", grade: 45, rawValue: 0.01, rawLabel: "Rush EPA allowed" },
      { group: "Pass Defense", grade: 52, rawValue: -0.01, rawLabel: "Pass EPA allowed" },
    ],
  },
];
...
export const opponentMatchup: OpponentMatchupData = {
  ...
  opponentInjuries,
  recentForm: {
    us: { last3EpaPerPlay: 0.06, last5EpaPerPlay: 0.04, seasonEpaPerPlay: 0.02, gamesPlayed: 8 },
    them: { last3EpaPerPlay: -0.03, last5EpaPerPlay: -0.01, seasonEpaPerPlay: -0.02, gamesPlayed: 8 },
  },
  priorBlendWeight: 0,
  headToHead: [
